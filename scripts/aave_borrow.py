...
def main():
    ...
    # Approve spending our ERC20 tokens
    ...
    print("Let's borrow!")
    # We wanna borrow some DAI but first we need to know the DAI/ETH conversion rate
    ...
    # borrowable_eth -> borroable_dai * 95%
    print(f"We are going to borrow {amount_dai_to_borrow} DAI")
    dai_address = dai_eth_price_feed = config["networks"][network.show_active()][
        "dai_token"
    ]
